  ...
  <tr valign="top">
    ...
    <td width="593" rowspan="2" bgcolor="#FFFFFF">
      ...
      <table width="80%"  border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#CCCCCC">
        <tr>
          <td height="162" align="center" bgcolor="#FFFFFF"><p>Thank you for your register.</p>
          <p>Our staff will contact you later to confirm the application, and after that, you'll obtain your password via the email. </p>
          <p>Cheers!</p></td>
        </tr>
      </table>
      <p>&nbsp;</p>
