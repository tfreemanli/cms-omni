...
$query_RS = sprintf("SELECT * FROM tbanm WHERE iID = %s", $colname_RS);
    ...
    <td width="593" rowspan="2" bgcolor="#FFFFFF">
      ...
      <table width="541"  border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          Home</a> &gt; <a href="ac_list.php">Accessories</a> &gt; <?php echo $row_RS['cModel']; ?></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td width="106" height="86" align="center"><a href="./productimg/<?php echo $row_RS['cImg']; ?>" target="_blank"><img src="./productimg/<?php echo $row_RS['cImg']; ?>" width="85" height="85" hspace="0" vspace="0" border="0"></a></td>
          <td width="377" rowspan="2" valign="top" bgcolor="#E4E4E4"><table width="100%"  border="0" cellspacing="0" cellpadding="4">
            <tr>
              <td width="71%" class="head_red_bold"><?php echo $row_RS['cBrand']; ?></td>
              <td width="29%" align="right" class="head_black_bold"> only <?php echo $row_RS['cPrice1']; ?></td>
            </tr>
            <tr valign="top">
              <td height="54" colspan="2"><p><span class="head_black_bold">Model:</span><?php echo $row_RS['cModel']; ?>                    <br>
                    <span class="head_black_bold">Description:</span><br>&nbsp;&nbsp;<?php echo str_replace("\n","<br>",$row_RS['cDesc']); ?></p>                </td>
              </tr>
            <tr>
              <td><p>                <span class="head_black_bold">Warranty: <?php echo $row_RS['cWrty']; ?></span></p>                </td>
              <td><a href="./cart.php?type=ac&id=<?php echo $row_RS['iID']; ?>"><img src="images/add.gif" width="54" height="22" border="0"></a></td>
            </tr>
          </table></td>
          <td width="36" rowspan="2">&nbsp;</td>
        </tr>
        <tr>
          <td height="8"><img src="images/accessories_line_12.gif" width="106" height="8"></td>
        </tr>
      </table>
