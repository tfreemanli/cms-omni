  ...
  <tr valign="top">
    ...
    <td width="593" rowspan="2" bgcolor="#FFFFFF">
      ...
      <table width="541"  border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="12" rowspan="2"><img src="images/accessories_line_09.gif" width="12" height="94"></td>
          ...
          <td width="377" rowspan="2" valign="top" bgcolor="#E4E4E4"><table width="100%"  border="0" cellspacing="0" cellpadding="4">
            <tr>
              <td width="32%" class="head_red_bold"><?php echo $row_RS['cBrand']; ?></td>
              <td width="68%" align="right" class="head_black_bold"> only <?php echo $row_RS['cPrice']; ?></td>
            </tr>
            <tr valign="top">
              <td height="54" colspan="2"><span class="head_black_bold">Model:</span><?php echo $row_RS['cModel']; ?><br>
                <span class="head_black_bold">Description:</span><br>                <?php echo $row_RS['cDesc']; ?></td>
              </tr>
            <tr>
              <td colspan="2"><p>                <span class="head_black_bold">Warranty: <?php echo $row_RS['cWrty']; ?></span></p>                </td>
              </tr>
          </table></td>
          <td width="36" rowspan="2"><img src="images/accessories_line_11.gif" width="38" height="94"></td>
        </tr>
        <tr>
