...
<?php 
$newpasswd = '';
if(isset($_POST['agentnum']) && $_POST['agentnum']!=''){
	mysql_select_db($database_localhost, $localhost);
	$query_ph = "SELECT cEmail,cName FROM tbcust where cVIPNum='".$_POST['agentnum']."'";
	$ph = mysql_query($query_ph, $localhost) or die(mysql_error());
	$row_ph = mysql_fetch_assoc($ph);
	$totalRows_ph = mysql_num_rows($ph);
	if($row_ph['cEmail']!=null && $row_ph['cEmail']!=''){
		$newpasswd = rand(1000,9999);
		//echo $newpasswd;
		$message = "Hi ". $row_ph['cName']. "\r\n";
		$message .= "  You can login as an agent of Omnitech.co.nz now. pls use your login:". $_POST['agentnum'] ." and password:". $newpasswd ."\r\n";
		$message .= "  Any question please contact info@omnitech.co.nz";
		$subject = "Password for agent login to OmniTech.co.nz";
		$headers  = "MIME-Version: 1.0\r\n";
		$headers .= "Content-type: text/html; charset=iso-8859-1\r\n";
		$headers .= "From: info@omnitech.co.nz\r\n";
		mail($row_ph['cEmail'], $subject, $message, $headers);
		//echo $message;
	}else{
		$MM_restrictGoTo = "error.php?info=Sorry, you did not left any email to us. pls contact omnitech for further assistance.";
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr valign="top">
    <td width="207" bgcolor="#FFFFFF"><table width="207" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td valign="top"><!-- InstanceBeginEditable name="Nav" --><img src="images/pic_left.gif" width="207" height="233"><!-- InstanceEndEditable --></td>
      </tr>
      <tr>
        <td>
          <!-- InstanceBeginEditable name="left" --><?php include('./inc_ad_left.php');?><?php include('./inc_ag_left.php');?><!-- InstanceEndEditable --></td>
      </tr>
    </table></td>
    <td width="593" rowspan="2" bgcolor="#FFFFFF">
      ...
      <table width="450" border="0" align="center">
        ...
        <tr>
          <td height="38" colspan="2" class="head_red_bold">Forgot your password? </td>
        </tr><form name="form1" method="post" action="">
        <tr>
          <td width="169">Enter your agent Number pls: </td>
          <td width="271">
            <input name="agentnum" type="text" id="agentnum">          </td>
        </tr>
        <tr>
          <td height="47" colspan="2">System will regenerate a new password when you click submit button below, and send the new password to your registed email address. If you forgot what's your email registed either, pls contact omnitech for assistance. </td>
          </tr>
        <tr>
          <td>&nbsp;</td>
	  ...
	  <table width="450" border="0" align="center">
        <tr>
          <td width="440" height="50">&nbsp;</td>
        </tr>
        <tr>
          <td height="38" class="head_red_bold">Great!</td>
        </tr>
        <tr>
          <td height="38">Your new password has been sent to <?php echo $row_ph['cEmail'];?>, please check that out. </td>
        </tr>
      </table>
