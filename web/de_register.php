...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tbdeal (cLogin, cStatus, cName, cEmail, cContact, cAdd, cMailAdd, cPerson, cDesc) VALUES (%s, 'apply', %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['cLoginR'], "text"),
  ...
  $insertGoTo = "de_register_suc.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
function add_usr(){
	//MM_validateForm('cLogin','','R','cName','','R','cEmail','','RisEmail','cContact','','R');
	var lg = MM_findObj('cLoginR');
	var errors = '';
  ...
  <tr valign="top">
    ...
    <td width="593" rowspan="2" bgcolor="#FFFFFF">
      ...
      <table width="100%"  border="0" align="center" cellpadding="3" cellspacing="5">
        <form name="frm_reg" id="frm_reg" method="POST" action="<?php echo $editFormAction; ?>">
          <tr>
            <td width="19%" align="right">Login:</td>
            <td width="81%">
              <input name="cLoginR" type="text" class="ipt_normal" id="cLoginR">            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><input name="cAdd" type="text" class="ipt_normal" id="cAdd"></td>
          </tr>
		  <tr>
			<td align="right">Mailing Address: </td>
			<td><input name="cMailAdd" type="text" class="ipt_normal" id="cMailAdd"></td>
		  </tr>
          <tr>
          ...
          <tr>
            ...
            <td><input name="cPerson" type="text" class="ipt_normal" id="cPerson"></td>
          </tr>
          <tr>
            <td align="right">Email:</td>
            <td><input name="cEmail" type="text" class="ipt_normal" id="cEmail"> 
            you'll receive the password via this email </td>
          </tr>
          <tr>
            <td align="right">Description:</td>
            <td><input name="cDesc" type="text" id="cDesc" size="50"></td>
          </tr>
          <tr>
            <td align="right"><input type="checkbox" name="checkbox" value="checkbox" onClick="javascript:d_chk(this);"></td>
            <td>I accept the <a href="de_register_tnd.php" target="_blank">Terms and Conditions</a> for Omni Tech Account Users</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><input name="Submit" id="Submit" type="button" class="btn" onClick="MM_validateForm('cLoginR','','R','cName','','R','cEmail','','RisEmail');add_usr();return document.MM_returnValue" value=" Submit " disabled="true"></td>
          </tr>
		  <script language="javascript">
		  <!--
		  function d_chk(chk){
			  var b = MM_findObj("Submit");
			  //alert(chk.checked);
