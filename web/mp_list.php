...
$query_RS = "SELECT * FROM tbanm WHERE iAorM = 1";
  ...
  <tr valign="top">
    ...
    <td width="593" rowspan="2" bgcolor="#FFFFFF">
      ...
      <table width="541"  border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td colspan="2"><img src="images/accessories_line_03.gif" width="118" height="13"></td>
          <td width="83" align="center" bgcolor="#E4E4E4" class="head_black_bold">Brand</td>
          <td width="78" align="center" bgcolor="#E4E4E4" class="head_black_bold">Code</td>
          <td width="104" align="center" bgcolor="#E4E4E4" class="head_black_bold">Type</td>
          <td width="66" align="center" bgcolor="#E4E4E4" class="head_black_bold">Price</td>
          <td width="54" align="center" bgcolor="#E4E4E4" class="head_black_bold">Stock</td>
          <td width="38" align="center"><img src="images/accessories_line_05.gif" width="38" height="13"></td>
        </tr>
        <?php do { ?>
        <tr>
          <td colspan="8"><img src="images/1x1.gif" width="1" height="5"></td>
        </tr>
        <tr>
          <td width="12" rowspan="4"><img src="images/accessories_line_09.gif" width="12" height="94"></td>
          <td width="106" rowspan="3" align="center"><a href="mp_detail.php?id=<?php echo $row_RS['iID'];?>"><img src="./productimg/<?php echo $row_RS['cImg']; ?>" width="85" height="85" hspace="0" vspace="0" border="0"></a></td>
          <td height="30" colspan="5" bgcolor="#E4E4E4">&nbsp;<span class="head_red_bold"><?php echo $row_RS['cBrand']; ?></span></td>
          <td rowspan="4" bgcolor="#FFFFFF"><img src="images/accessories_line_11.gif" width="38" height="94"></td>
        </tr>
        <tr>
          <td height="23" align="center" bgcolor="#E4E4E4"><?php echo $row_RS['cBrand']; ?></td>
          <td align="center" bgcolor="#E4E4E4"><?php echo $row_RS['cPC']; ?></td>
          <td align="center" bgcolor="#E4E4E4"><?php echo $row_RS['cType']; ?></td>
          <td align="center" bgcolor="#E4E4E4"><?php echo $row_RS['cPrice']; ?></td>
          <td align="center" bgcolor="#E4E4E4"><?php echo $row_RS['cInStk']; ?></td>
        </tr>
        <tr>
          <td height="31" colspan="5" valign="bottom" bgcolor="#E4E4E4">&nbsp;<span class="head_black_bold">Model:</span> <?php echo $row_RS['cModel']; ?></td>
        </tr>
        <tr>
          <td height="8"><img src="images/accessories_line_12.gif" width="106" height="8" hspace="0" vspace="0"></td>
          <td colspan="5" bgcolor="#E4E4E4"><img src="images/1x1.gif" width="1" height="8"></td>
        </tr>
