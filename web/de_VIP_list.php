...
if(isset($_GET['cField'])){
	...
	$where_clu .= " and  cStatus = 'normal' and cIsVIP='1'";
...
function do_sch(){
	...
	MM_goToURL('window','de_VIP_list.php?cField='+ field.options[field.selectedIndex].value +'&cOp='+ op.options[op.selectedIndex].value +'&cVal='+ val.value);
	return;
}
//-->
</script>
  ...
  <tr valign="top">
    ...
    <td width="593" rowspan="2" bgcolor="#FFFFFF">
      ...
      <table width="530" border="0" align="center" cellpadding="2" cellspacing="5">
        <tr>
          <td class="head_red_bold">VIP Members 
            <?php include('repair/myfunction.php');?></td>
        </tr>
        <tr>
          <td>
   ...
   &nbsp;&nbsp;&nbsp;<select name="field" id="field">
      ...
      <option value="cVIPNum">VIP Num</option>
      ...
      <table width="530" border="0" align="center" cellpadding="2" cellspacing="5">
        <tr>
          <td><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
            <tr class="head_white_bold" align="center">
              <td width="11" valign="top" background="repair/images/cms_20.gif"><img src="repair/images/cms_19.gif" width="11" height="12"></td>
              <td width="98" background="repair/images/cms_22.gif" class="right_solid_1">Name</td>
              <td width="92" background="repair/images/cms_22.gif" class="right_solid_1">VIP No. </td>
              <td width="96" background="repair/images/cms_22.gif" class="right_solid_1">Start Dt </td>
              <td width="96" background="repair/images/cms_22.gif" class="right_solid_1">Exp. Dt</td>
              <td width="78" background="repair/images/cms_22.gif" class="right_solid_1">Email</td>
              <td width="45" background="repair/images/cms_22.gif" class="right_solid_1">Opr</td>
            </tr>
            <?php
   $col = "#FFFFFF";
    do { ?>
            <tr bgcolor="<?php echo $col;?>" class="font_red_12">
              ...
              <td bgcolor="<?php echo $col;?>" class="right_solid_1"><?php echo $row_rs['cName']; ?> <?php echo $row_rs['cLastName']; ?></td>
              <td class="right_solid_1"><?php echo $row_rs['cVIPNum']; ?>&nbsp;</td>
              <td class="right_solid_1"><?php echo $row_rs['cVIPVDate']; ?>&nbsp;</td>
              <td class="right_solid_1"><?php echo $row_rs['cVIPEDate']; ?>&nbsp;</td>
              <td class="right_solid_1"><?php echo $row_rs['cEmail']; ?>&nbsp;</td>
              <td class="right_solid_1"><a href="de_VIP_edit.php?iID=<?php echo $row_rs['iID']; ?>">Detail</a></td>
            </tr>
            <?php
  		if($col == "#FFFFFF"){
			$col = "#E3E3E3";
            ...
            <tr>
              <td background="repair/images/cms_20.gif">&nbsp;</td>
              <td colspan="9" bgcolor="<?php echo $col?>">
