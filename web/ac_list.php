...
$query_RS = sprintf("SELECT * FROM tbanm WHERE iAorM = 2 %s ORDER BY cPC, dtDate DESC",$where_clu);
...
<title>OmniTech - Accessories</title>
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr valign="top">
    <td width="207" bgcolor="#FFFFFF"><table width="207" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td>
          <!-- InstanceBeginEditable name="left" --><?php include('./inc_ac_left.php');?><!-- InstanceEndEditable --></td>
      </tr>
    </table></td>
    <td width="593" rowspan="2" bgcolor="#FFFFFF">
      ...
      <table width="95%"  border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td colspan="8">&nbsp;<br>&nbsp;<a href="./index_ph.php">
          Home</a> &gt; <span class="head_red_bold">Accessories</span> </td>
        </tr>
        <tr>
          <td colspan="8"><img src="images/1x1.gif" width="1" height="7"></td>
        </tr>
        <tr>
          <td colspan="2" bgcolor="#E4E4E4">&nbsp;</td>
          <td width="90" align="center" bgcolor="#E4E4E4" class="head_black_bold">Brand</td>
          <td width="77" align="center" bgcolor="#E4E4E4" class="head_black_bold">Code</td>
          <td width="92" align="center" bgcolor="#E4E4E4" class="head_black_bold">Type</td>
          <td width="77" align="center" bgcolor="#E4E4E4" class="head_black_bold">Price</td>
          <td width="75" align="center" bgcolor="#E4E4E4" class="head_black_bold">Stock</td>
        ...
        <tr>
          ...
          <td width="106" rowspan="3" align="center"><a href="ac_detail.php?id=<?php echo $row_RS['iID'];?>"><img src="./productimg/<?php echo $row_RS['cImg']; ?>" width="85" height="85" hspace="0" vspace="0" border="0"></a></td>
          <td height="51" colspan="5" bgcolor="#E4E4E4">&nbsp;<span class="head_red_bold"><?php echo $row_RS['cBrand']; ?></span></td>
        ...
        <tr>
          ...
          <td align="center" bgcolor="#E4E4E4"><?php echo $row_RS['cPrice1']; ?></td>
          <td align="center" bgcolor="#E4E4E4"><?php echo $row_RS['cInStk']; ?></td>
        </tr>
        <tr>
          <td height="21" colspan="5" valign="top" bgcolor="#E4E4E4">&nbsp;</td>
        </tr>
        <tr>
          <td height="8"><img src="images/1x1.gif" width="1" height="8" hspace="0" vspace="0"></td>
          <td colspan="4" bgcolor="#E4E4E4"><img src="images/1x1.gif" width="1" height="8">&nbsp;<span class="head_black_bold">Model:</span> <?php echo $row_RS['cModel']; ?></td>
