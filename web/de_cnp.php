...
$colname_RS_dealer = $_SESSION['DE_Username'];
...
$colname_RS_paid = $_SESSION['DE_Username'];
mysql_select_db($database_localhost, $localhost);
...
Zealand">
<META NAME="revisit-after" CONTENT="4">
<!-- MetaTags - Online Meta Tag <a href="http://www.onlinemetatag.com" target="_blank">http://www.onlinemetatag.com</a> -->
<!-- Create your meta tag and increase your website position on
search engines! -->
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr valign="top">
    ...
    <td width="593" rowspan="2" bgcolor="#FFFFFF">
	  ...
	  <table width="587"  border="0" cellspacing="14" cellpadding="0">
        <tr>
          <td width="559"><table width="554"  border="0" align="center" cellpadding="5" cellspacing="10">
            <tr>
              <td width="404" class="head_black_bold">Credit &amp; Payment </td>
              <td width="100" align="center">&nbsp;</td>
            </tr>
          </table>
            <hr size="1">
            <table width="559" height="36" border="0" align="center" cellpadding="5" cellspacing="0">
              <tr class="Mgr_Heading">
                <td width="353"><strong>Credit Balance </strong></td>
                <td width="186" align="right">$<?php echo $credit;?></td>
              </tr>
            </table>
            <hr size="1">
            <table width="559"  border="0" align="center" cellpadding="5" cellspacing="0">
              <tr>
                <td colspan="3"><strong>Payment List </strong></td>
              </tr>
              <tr align="center" bgcolor="#E3E3E3" class="font_white_9bold" background="./images/cms_22.gif">
                <td width="120" align="center" background="./images/cms_22.gif" class="right_solid_1">Received Date </td>
                <td width="125" align="center" background="./images/cms_22.gif" class="right_solid_1">Amount</td>
                <td width="284" align="center" background="./images/cms_22.gif" class="right_solid_1">Ref</td>
              </tr>
              <?php
	   $col = "#FFFFFF";
	   do { ?>
