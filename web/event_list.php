...
$query_RS = "SELECT * FROM tbanm WHERE iAorM = 3 ORDER BY iShowIndex desc, iID desc";
  ...
  <tr valign="top">
    ...
    <td width="593" rowspan="2" bgcolor="#FFFFFF">
      ...
      <table width="95%"  border="0" align="center" cellpadding="5" cellspacing="5">
        <tr>
          <td><span class="style3">NEWS</span></td>
        </tr>
      </table>
        <?php do { ?>
      <table width="95%"  border="0" align="center" cellpadding="5" cellspacing="5">
        <tr>
          <td width="3%" background="images/contact_line_01.gif">&nbsp;</td>
          <td colspan="2" bgcolor="#ECECEC"><a href="event_detail.php?iID=<?php echo $row_RS['iID']; ?>"><?php echo $row_RS['cPC']; ?></a>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td width="23%" valign="top"><a href="event_detail.php?iID=<?php echo $row_RS['iID']; ?>"><img src="./productimg/<?php echo $row_RS['cImg']; ?>" width="70" height="93" hspace="20" vspace="5" border="0"></a></td>
          <td width="74%" align="left" valign="top">
		  <?php
		   $tmp = str_replace("\n","<br>",$row_RS['cDesc']);
		   		if(strlen($tmp)>510){
					echo substr($tmp, 0, strpos($tmp, ' ', 500))."...";
				}else{
					echo $tmp;
				} 
		   ?>&nbsp;</td>
