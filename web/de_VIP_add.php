...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tbcust (cName, cLastName, cHomePhn, cWorkPhn, cAdd1, cAdd2, cAdd3, cFax, cEmail, cIsVIP, cVIPNum, cVIPVDate, cVIPEDate, cSbmBy, cMake, cModel, cIMEI) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, '1', %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_SESSION['DE_Username'], "text"),
...
function add_usr(){
	MM_validateForm('cName','','R','cVIPVDate','','R','cVIPEDate','','R');
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <td><table width="95%"  border="0" align="center" cellpadding="3" cellspacing="1">
              <form name="form1" method="POST" action="">
                ...
                <tr>
                  ...
                  <td><input name="cLastName" type="text" class="ipt_normal" id="cLastName"></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td><input name="cVIPVDate" type="text" class="ipt_normal" id="cVIPVDate"></td>
                </tr>
                <tr>
                  <td align="right">*Expire Date: </td>
                  <td><input name="cVIPEDate" type="text" class="ipt_normal" id="cVIPEDate"></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td><input name="cFax" type="text" class="ipt_normal" id="cFax"></td>
                </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input name="cMake" type="text" class="ipt_normal" id="cMake"></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input name="cIMEI" type="text" class="ipt_normal" id="cIMEI"></td>
  </tr>
                <tr>
                  <td>&nbsp;</td>
