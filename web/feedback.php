...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tbfeedback (type, name, `desc`, date) VALUES ('index', %s, %s, NOW())",
                       GetSQLValueString($_POST['name'], "text"),
                       GetSQLValueString(addslashes(htmlspecialchars($_POST['desc'])), "text"));
  ...
  <tr valign="top">
    ...
    <td width="593" rowspan="2" bgcolor="#FFFFFF">
      ...
      <table width="95%"  border="0" align="center" cellpadding="5" cellspacing="5">
        <tr>
          <td class="head_red_bold">Feedback</td>
        </tr>
      </table>
	  <?php 
	  if($IsSent==1){
...
<table width="95%"  border="0" align="center" cellpadding="5" cellspacing="5">
        <tr>
          <td><span class="STYLE1">Thank you!</span> Your feedback has been sent to us successfully.</td>
        </tr>
      </table>
	  <?php 
	  }//end if is sent
      ...
      <table width="95%"  border="0" align="center" cellpadding="5" cellspacing="5">
        ...
        <tr>
          <td width="20%" align="right" valign="top">Your Name: </td>
          <td width="80%" valign="top">
            <input name="name" type="text" id="name"></td>
        </tr>
        <tr>
          <td align="right" valign="top"><span class="STYLE1">*</span> Feedback:</td>
          <td valign="top"><textarea name="desc" cols="50" rows="10" wrap="VIRTUAL" id="desc"></textarea></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
