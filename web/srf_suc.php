  ...
  <tr valign="top">
    ...
    <td width="593" rowspan="2" bgcolor="#FFFFFF">
      ...
      <table width="90%"  border="0" align="center" cellpadding="2" cellspacing="5">
        ...
        <tr>
          <td> Thank you for submitting your job to us, your JOB No. is <span class="head_red_bold"><?php echo $jn;?></span>. </td>
        </tr>
        <tr align="center">
          <td><input type="button" name="Submit" value="print" onClick="javascript:window.print();"></td>
        </tr>
      </table>
