  ...
  <tr valign="top">
    ...
    <td width="593" rowspan="2" bgcolor="#FFFFFF">
      ...
      <table width="100%"  border="0" cellspacing="14" cellpadding="0">
        <tr>
          <td height="43" class="head_red_bold">Forgot Password? </td>
        </tr>
        <tr>
          <td height="39"><p><span class="head_black_bold">Step 1</span>- Please enter your login name and Email address, and then press OK button. </p>
          <table width="90%"  border="0" align="center" cellpadding="2" cellspacing="5">
              <form name="form1" method="post" action="de_fgt_psw_suc.php">
			  <tr>
                <td width="17%">* Login Name </td>
                <td width="83%">
              ...
              <tr>
                <td>* Email</td>
                <td><input name="email" type="text" id="email" size="15">
                  (must be the same as the email when register)</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td><input name="Submit" type="submit" onClick="MM_validateForm('login','','R','email','','RisEmail');return document.MM_returnValue" value=" OK ">
                  <input name="MM_query" type="hidden" id="MM_query" value="form1"></td>
              </tr>
			  </form>
          </table>            <p>&nbsp;</p></td>
        </tr>
        <tr>
          <td><strong>Step 2</strong> - Check your Email to find out your new password. </td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        </tr>
