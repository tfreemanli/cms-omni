  ...
  <tr valign="top">
    ...
    <td width="593" rowspan="2" bgcolor="#FFFFFF">
      ...
      <table width="100%"  border="0" cellspacing="14" cellpadding="0">
        <tr>
          <td><p class="head_black_bold"><strong>Terms and Condition for $49.95 Mobile Phone Repair </strong></p>
            <p>  The offer is valid for until 31st December 2007 and only meant for direct, walk-in customers of Omni Tech Limited only. Offer does not cover units sent in by authorized agents and dealers of Omni Tech Limited. <br>
              <br>
Repair cost of maximum $49.95 for repair your phone (plus GST). </p>
            <p>If phone is beyond repair, owner agrees to pay  for technical service and inspection rendered. </p>
            <p>If repaired phone is confirmed to be blacklisted by network career, owner is still liable for the  service charge mentioned above.</p>
            <p><strong>The repair offer includes : </strong></p>
            <p>(1) The cost of software and unlock repair </p>
            <p>(2) The cost of microphone and speaker repair</p>
            <p><strong>The repair offer does not cover the following type of phone : </strong></p>
            <p>(1) Smartphone (e.g. Treo 650), PDA phone </p>
            <p>(2) Non-standard GSM mobile phone </p>
            <p><strong>  Mobile phone accessories and SIM Card : </strong></p>
            <p>Customer must remove all SIM cards, pouch, and decorative items before sending the phone for repair. </p>
            <p>The company will NOT be responsible for missing SIM cards or decorative items. </p>
            <p>Owner must agree to the abovementioned terms &amp; condition before taking up this offer <br>
                <br>
                <strong>Mobile phone data and content safety : </strong><br>
  Please note that application, information, ring tones, games and other personal data may be permanently lost during repair process. We highly recommended that owner backup all data before sending device for repair. None of the parties associated with the repair process, including Omni Tech Limited, the service repair agents or the dealers shall be liable for the loss of any personal information or data on the device. </p>
            <p>&nbsp;</p></td>
        </tr>
      </table>
