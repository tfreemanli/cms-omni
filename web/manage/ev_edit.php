...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="10">
  <tr>
    <td><table width="530"  border="0" cellpadding="5" cellspacing="2" bgcolor="#CADB2A">
      <form name="form3" enctype="multipart/form-data" method="POST" action="ev_del.php">
        <tr>
          <td width="55%" height="31"><span class="font_white_9bold">■ Delete the event </span></td>
          <td width="45%" align="right"><input name="img" type="hidden" id="img4" value="<?php echo $row_RS1['cImg']; ?>">
              ...
              <input type="button" name="Submit32" value="Delete" onClick="javascript:ev_del();"></td>
        </tr>
        <input type="hidden" name="MM_update3" value="form3">
      </form>
    </table>
      <br>
      <table width="530"  border="0" cellpadding="2" cellspacing="1">
        <form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="form1">
          <tr bgcolor="#CADB2A">
            <td colspan="4" class="font_white_9bold"><img src="images/1x1.gif" width="1" height="1" hspace="2" vspace="10" align="absmiddle">Modify the event</td>
          </tr>
          <tr>
            <td width="92" align="right" class="td_block">title</td>
            <td width="623">
              <input name="cPC" type="text" class="ipt_normal" id="Title" value="<?php echo $row_RS1['cPC']; ?>"></td>
          </tr>
          <tr>
            <td align="right" class="td_block">Content</td>
            <td><textarea name="cDesc" wrap="VIRTUAL" class="text_normal" id="Content"><?php echo $row_RS1['cDesc']; ?></textarea></td>
          </tr>
          <tr>
            <td colspan="4" align="center" valign="top"><input name="Submit" type="submit" class="btn" onClick="MM_validateForm('Title','','R','Content','','R');return document.MM_returnValue" value="Submit">
...
<input name="iID" type="hidden" id="iID3" value="<?php echo $row_RS1['iID']; ?>">
                ...
                <input name="cInStk" type="hidden" class="ipt_normal" id="cInStk2" value="<?php echo $row_RS1['cInStk']; ?>"></td>
          </tr>
          <tr>
      ...
      <table width="530"  border="0" cellpadding="5" cellspacing="2">
        <form name="form2" enctype="multipart/form-data" method="POST" action="<?php echo $editFormAction; ?>">
          ...
          <tr>
            <td width="60%" height="31" align="center" valign="top">
              ...
              <p> * left it blank and submit can remove the image from the event. </p></td>
