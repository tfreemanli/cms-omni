...
$query_Recordset1 = sprintf("SELECT * FROM tbcart WHERE cRef = '%s'", $colname_Recordset1);
...
mysql_select_db($database_localhost, $localhost);
$query_RS2 = sprintf("SELECT * FROM tbcartitems WHERE cRef = '%s'", $colname_RS2);
...
<table width="530"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="25" bgcolor="#FFFFFF" class="Mgr_Heading">Shopping Cart Order Detail</td>
  </tr>
  <tr>
...
<table width="530"  border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    <td>Name:</td>
    <td><?php echo $row_Recordset1['cFName']; ?> <?php echo $row_Recordset1['cLName']; ?></td>
    <td>Contact:</td>
    <td><?php echo $row_Recordset1['cContact']; ?></td>
  </tr>
  <tr>
    <td>Email:</td>
    <td><?php echo $row_Recordset1['cEmail']; ?></td>
    <td>Address</td>
    <td><?php echo $row_Recordset1['cAdd']; ?></td>
  </tr>
  <tr>
    <td>Price:</td>
    <td><?php echo $row_Recordset1['fPrice']; ?></td>
    <td>Collect By: </td>
    <td>$<?php echo $row_Recordset1['iCB']; ?></td>
  </tr>
</table>
<br>
<table width="530"  border="0" cellpadding="0" cellspacing="0">
  ...
  <tr bgcolor="<?php echo $col;?>" class="font_red_12">
    ...
    <td class="right_solid_1"><?php echo $row_RS2['cPrice'];?></td>
  ...
  <tr bgcolor="<?php echo $col;?>" class="font_red_12">
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td align="right" bgcolor="<?php echo $col;?>">Shipping:</td>
    <td><?php echo $row_Recordset1['iCB']; ?></td>
  </tr>
  <tr bgcolor="<?php echo $col;?>" class="font_red_12">
    <td class="font_red_12">&nbsp;</td>
