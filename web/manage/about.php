...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tbwebinfo SET tbwebinfo.desc=%s WHERE title='about'", GetSQLValueString($_POST['desc'], "text"));
...
mysql_select_db($database_localhost, $localhost);
$query_RS1 = sprintf("SELECT * FROM tbwebinfo WHERE title = 'about'");
  ...
  <tr>
    <td><table width="530"  border="0" cellpadding="2" cellspacing="1">
        <form action="<?php echo $editFormAction; ?>" method="POST" enctype="multipart/form-data" name="form1">
          <tr bgcolor="#CADB2A">
            <td colspan="4" class="font_white_9bold"><img src="images/1x1.gif" width="1" height="1" hspace="2" vspace="10" align="absmiddle">Modify the ABOUT US</td>
          </tr>
          <tr>
