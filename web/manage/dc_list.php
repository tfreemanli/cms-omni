...
if ((isset($_GET['act'])) && ($_GET['act'] == "del")) {
  $deleteSQL = sprintf("DELETE FROM tbdecart WHERE cRef=%s",
                       GetSQLValueString($_GET['ref'], "text"));

  mysql_select_db($database_localhost, $localhost);
  $Result1 = mysql_query($deleteSQL, $localhost) or die(mysql_error());
  
  $deleteSQL = sprintf("DELETE FROM tbdecartitems WHERE cRef=%s",
                       GetSQLValueString($_GET['ref'], "text"));
...
mysql_select_db($database_localhost, $localhost);
$query_Recordset1 = sprintf("SELECT * FROM tbdecart WHERE cRef is not null %s ORDER BY cRef DESC",$where_clu);
...
<table width="530"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="25" bgcolor="#FFFFFF" class="Mgr_Heading">Dealer's Order</td>
  </tr>
  <tr>
...
<table width="530"  border="0" cellpadding="0" cellspacing="0">
  ...
  <tr bgcolor="<?php echo $col?>" class="font_red_12">
    ...
    <td class="right_solid_1"><a href="dc_edit.php?ref=<?php echo $row_Recordset1['cRef'];?>"><?php echo $row_Recordset1['cRef']; ?></a></td>
    <td class="right_solid_1"><?php echo $row_Recordset1['dtDate']; ?></td>
    <td class="right_solid_1"><?php echo $row_Recordset1['cDName']; ?></td>
    <td class="right_solid_1"><?php echo $row_Recordset1['fPrice']; ?></td>
    <td><a href="#" onClick="javascript: if(cfm()) MM_goToURL('window','dc_list.php?act=del&ref=<?php echo $row_Recordset1['cRef'];?>');">Cancel</a></td>
  </tr>
  <?php
  		if($col == "#FFFFFF"){
			$col = "#E3E3E3";
