...
$query_Recordset1 = "SELECT * FROM tbanm WHERE iAorM = 3 ORDER BY  iShowIndex desc, iID desc";
...
<table width="100%"  border="0" align="center" cellpadding="5" cellspacing="10">
  <tr>
    ...
    <td width="18%" align="center" class="td_block"><a href="ev_add.php">ADD &gt;&gt;</a> </td>
  </tr>
</table>
  ...
  <tr>
    <td><table width="100%"  border="0" cellpadding="5" cellspacing="0">
      <tr align="center" class="font_white_9bold" background="images/cms_22.gif">
        <td width="20%" background="../manage/images/m_tb_head.gif" class="right_solid_1">Post Date </td>
        <td width="23%" background="../manage/images/m_tb_head.gif" class="right_solid_1">Title</td>
        <td width="55%" background="../manage/images/m_tb_head.gif" class="right_solid_1">Content</td>
      </tr>
      <?php
   $col = "#FFFFFF";
    do { ?>
      <tr bgcolor="<?php echo $col?>" class="font_red_12">
        <td class="right_solid_2"><?php echo $row_Recordset1['dtDate']; ?></td>
        <td class="right_solid_2"><a href="ev_edit.php?iID=<?php echo $row_Recordset1['iID'];?>"><?php echo $row_Recordset1['cPC']; ?></a></td>
        <td><?php echo substr($row_Recordset1['cDesc'],0,30); ?>...</td>
      </tr>
      <?php
  		if($col == "#FFFFFF"){
			$col = "#E3E3E3";
      ...
      <tr>
        <td bgcolor="<?php echo $col?>" colspan="3">
