...
$query_Recordset1 = "SELECT * FROM tbanm WHERE iAorM = 4 ORDER BY  iShowIndex desc, iID desc";
...
<table width="100%"  border="0" align="center" cellpadding="5" cellspacing="10">
  <tr>
    <td width="82%" class="Mgr_Heading">Special Promotion</td>
  ...
  <tr>
    <td><table width="100%"  border="0" cellpadding="5" cellspacing="0">
      <tr align="center" class="font_white_9bold" background="images/cms_22.gif">
        <td width="2%" background="../manage/images/m_tb_head.gif" class="right_solid_1">&nbsp;</td>
        <td width="88%" background="../manage/images/m_tb_head.gif" class="right_solid_1">Content</td>
        <td width="10%" background="../manage/images/m_tb_head.gif" class="right_solid_1">Opr</td>
      </tr>
      <?php
   $col = "#FFFFFF";
    do { ?>
      <tr bgcolor="<?php echo $col?>" class="font_red_12">
        ...
        <td class="right_solid_2"><?php echo substr($row_Recordset1['cDesc'],0,100); ?>...</td>
        <td><a href="sp_edit.php?iID=<?php echo $row_Recordset1['iID'];?>">Edit</a></td>
      </tr>
      <?php
  		if($col == "#FFFFFF"){
			$col = "#E3E3E3";
