...
$colname_rs = "1";
if (isset($_SESSION['AC_Username'])) {
  $colname_rs = (get_magic_quotes_gpc()) ? $_SESSION['AC_Username'] : addslashes($_SESSION['AC_Username']);
}
mysql_select_db($database_localhost, $localhost);
$query_rs = sprintf("SELECT * FROM tbuser WHERE cLogin = '%s'", $colname_rs);
...
<table width="100%"  border="0" align="center" cellpadding="5" cellspacing="10">
  <tr>
    <td class="Mgr_Heading">My Info </td>
    </tr>
</table>
