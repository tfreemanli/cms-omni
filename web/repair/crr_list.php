...
$query_rs = "SELECT * FROM tbcourier ORDER BY name ASC";
...
<table width="100%"  border="0" align="center" cellpadding="5" cellspacing="10">
      <tr>
        <td width="82%" class="Mgr_Heading">Couriers </td>
        <td width="18%" align="center" class="td_block"><a href="./crr_add.php">ADD &gt;&gt;</a> </td>
      </tr>
    </table>
	<table width="692"  border="0" cellpadding="5" cellspacing="0">
      <tr background="../manage/images/m_tb_head.gif">
        <td width="157" align="center" background="../manage/images/m_tb_head.gif" class="font_white_9bold">Name</td>
        <td width="420" align="center" background="../manage/images/m_tb_head.gif" class="font_white_9bold">Website</td>
        <td width="85" align="center" background="../manage/images/m_tb_head.gif" class="font_white_9bold">Opr</td>
      </tr>
        <?php do { ?>
      <tr>
          <td class="right_solid_2"><?php echo $row_rs['name']; ?></td>
          <td class="right_solid_2">http://<?php echo $row_rs['url']; ?></td>
          <td><a href="./crr_edit.php?iID=<?php echo $row_rs['id']; ?>">Edit</a> <a href="./crr_del.php?iID=<?php echo $row_rs['id']; ?>" onClick="if(!confirm('Are you sure?')){return false;}">Delete</a> </td>
      </tr>
