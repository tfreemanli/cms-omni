...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tbopr (cLogin, cPsw, cName, cEmail, cContact, role) VALUES (%s, %s, %s, %s, %s, 'tech')",
...
<form name="form1" method="POST" action="<?php echo $editFormAction; ?>">
  <tr>
    <td width="20%" align="right" bgcolor="#8F1128" class="td_block">Login:</td>
    <td width="80%">
      <input name="cLogin" type="text" class="ipt_normal" id="cLogin">
      * 'admin' is reserved    </td>
  </tr>
  <tr>
    <td align="right" bgcolor="#8F1128" class="td_block">Password:</td>
  ...
  <tr>
    <td align="right" bgcolor="#8F1128" class="td_block">Name:</td>
