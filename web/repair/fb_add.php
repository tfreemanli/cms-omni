...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tbfeedback (`desc`, date, status) VALUES (%s, now(), '0')",
                       GetSQLValueString($_POST['desc'], "text"));

  mysql_select_db($database_localhost, $localhost);
  $Result1 = mysql_query($insertSQL, $localhost) or die(mysql_error());

  $insertGoTo = "fb_list.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<table width="100%"  border="0" align="center" cellpadding="5" cellspacing="10">
	...
	<table width="100%" border="0" cellspacing="5" cellpadding="5">
      <tr>
        <td width="15%" valign="top">Enter your feedback description </td>
        <td width="85%">
          <textarea name="desc" wrap="virtual" class="text_normal" id="desc"></textarea>
        </td>
      </tr>
      <tr>
        <td>&nbsp;</td>
