...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form4")) {
  $updateSQL = sprintf("UPDATE tbcust SET cPasswd='1234' WHERE iID=%s",
                       GetSQLValueString($_POST['iID'], "int"));
    ...
    <td  valign="top">	<!-- InstanceBeginEditable name="main" --><br> 
        <table width="100%"  border="0" align="center" cellpadding="5" cellspacing="10">
          <tr>
            ...
            <td width="18%" align="center" class="td_block"><a href="ag_list.php">&lt;&lt; Back to list</a> </td>
          </tr>
        </table>
      <br>
<?php
...
<table width="538"  border="0" cellpadding="5" cellspacing="2" bgcolor="#CADB2A">
  <form name="form3" enctype="multipart/form-data" method="POST" action="<?php echo $editFormAction; ?>">
    <tr>
      <td width="55%" height="31">■ Delete the Agent </td>
...
<table width="538" border="0" cellspacing="5" cellpadding="2"><form name="form1" method="POST" action="<?php echo $editFormAction; ?>">
  ...
  <tr>
    ...
    <td><textarea name="cFax" wrap="VIRTUAL" class="ipt_normal" id="cFax" style="width:250px;height:150px; "><?php echo $row_rs['cFax']; ?></textarea></td>
  </tr>

  <tr>
    <td>&nbsp;</td>
    <td>
      <input name="Submit2" type="submit" class="btn" onClick="MM_validateForm('cName','','R','cVIPNum','','R');return document.MM_returnValue" value="submit">
      ...
      <input name="cIMEI" type="hidden" class="ipt_normal" id="cIMEI" value="<?php echo $row_rs['cIMEI']; ?>"></td>
  <input type="hidden" name="MM_update" value="form1">
  </tr>
    </form>
	<form method="post" name="form4" id="form4" action="<?php echo $editFormAction; ?>">
	<tr>
	    <td><input type="hidden" name="MM_update" value="form4">
      <input name="iID" type="hidden" id="iID" value="<?php echo $row_rs['iID']; ?>"></td>
	    <td><input name="Submit" type="submit" class="btn" value="Reset Password"> 
	      restore agent's password to default password, eg '1234'</td>
	</tr>
	</form>
</table>
<br>
