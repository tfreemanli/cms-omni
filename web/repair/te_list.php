...
$query_rs = "SELECT * FROM tbopr WHERE role='tech' and cStatus = 'normal' ORDER BY iID DESC";
...
<table width="100%"  border="0" align="center" cellpadding="5" cellspacing="10">
  <tr>
    <td width="82%" class="Mgr_Heading">Technician</td>
    <td width="18%" align="center" class="td_block"><a href="te_add.php">ADD &gt;&gt;</a> </td>
  </tr>
</table>
   ...
   $col = "#FFFFFF";
    do { ?>
      <tr bgcolor="<?php echo $col;?>">
        ...
        <td><a href="te_edit.php?iID=<?php echo $row_rs['iID']; ?>">Modify</a></td>
      </tr>
      <?php
  		if($col == "#FFFFFF"){
			$col = "#E3E3E3";
