    ...
    <td  valign="top">	<!-- InstanceBeginEditable name="main" --><br> 
        <table width="100%"  border="0" align="center" cellpadding="5" cellspacing="10">
          <tr>
            ...
            <td width="18%" align="center" class="td_block"><a href="te_list.php">&lt;&lt; Back to list</a> </td>
          </tr>
        </table>
      <br>
<?php
...
<table width="538"  border="0" cellpadding="5" cellspacing="2" bgcolor="#CADB2A">
  <form name="form3" enctype="multipart/form-data" method="POST" action="<?php echo $editFormAction; ?>">
    <tr>
      <td width="55%" height="31">■ Delete the technician </td>
...
<table width="538" border="0" cellspacing="5" cellpadding="2">
  ...
  <tr bgcolor="#CADB2A">
    <td colspan="2" class="font_white_9bold"><img src="images/1x1.gif" width="1" height="1" hspace="2" vspace="10" align="absmiddle">Modify technician's information </td>
    </tr>
  <tr>
...
<table width="538" border="0" cellspacing="5" cellpadding="2">
  <form name="form2" method="POST" action="<?php echo $editFormAction; ?>">
    <tr bgcolor="#CADB2A">
      <td colspan="2" class="font_white_9bold"><img src="images/1x1.gif" width="1" height="1" hspace="2" vspace="10" align="absmiddle">Modify technician's password </td>
    </tr>
    <tr>
