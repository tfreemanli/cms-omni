...
$query_rs = "SELECT * FROM tbdeal WHERE cStatus = 'normal' ORDER BY iID DESC";
...
<table width="100%"  border="0" align="center" cellpadding="5" cellspacing="10">
  <tr>
    <td width="64%" class="Mgr_Heading">Dealer</td>
    <td width="18%" align="center" class="td_block"><a href="de_list_apl.php">APPLYING &gt;&gt; </a></td>
    <td width="18%" align="center" class="td_block"><a href="de_add.php">ADD &gt;&gt;</a> </td>
  </tr>
</table>
  ...
  <tr>
    <td><table width="100%"  border="0" align="center" cellpadding="5" cellspacing="0">
      <tr class="font_white_9bold" align="center">
        <td width="80" background="../manage/images/m_tb_head.gif" class="right_solid_1">Login</td>
        <td width="124" background="../manage/images/m_tb_head.gif" class="right_solid_1">Company Name</td>
        <td width="118" background="../manage/images/m_tb_head.gif" class="right_solid_1">Email</td>
        <td width="161" background="../manage/images/m_tb_head.gif" class="right_solid_1">Contact No.</td>
        <td width="156" background="../manage/images/m_tb_head.gif" class="right_solid_1">Contact Person</td>
        <td width="69" background="../manage/images/m_tb_head.gif" class="right_solid_1">Opr</td>
      </tr>
      <?php
   $col = "#FFFFFF";
    do { ?>
      <tr bgcolor="<?php echo $col;?>" class="font_red_12">
        ...
        <td><a href="de_edit.php?iID=<?php echo $row_rs['iID']; ?>">Modify</a></td>
      </tr>
      <?php
  		if($col == "#FFFFFF"){
			$col = "#E3E3E3";
