...
if ((isset($_GET["iID"])) && ($_GET["iID"] != "")) {
	...
	$query_del = "delete from tbdo where iID='".$_GET['iID']."'";
	$Result = mysql_query($query_del, $localhost) or die(mysql_error());
	$query_del = "delete from tbdodetail where iDoID='".$_GET['iID']."'";
	$Result = mysql_query($query_del, $localhost) or die(mysql_error());
