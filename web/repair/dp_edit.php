...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tbdiscpsw SET cPsw=%s, cDesc=%s WHERE iID=%s",
...
mysql_select_db($database_localhost, $localhost);
$query_rs = sprintf("SELECT * FROM tbdiscpsw WHERE iID = %s", $colname_rs);
...
<table width="100%"  border="0" align="center" cellpadding="5" cellspacing="10">
  <tr>
    ...
    <td width="18%" align="center" class="td_block"><a href="dp_list.php">&lt;&lt; Back to list</a> </td>
  </tr>
</table>
<br>
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="10">
  <tr>
    <td class="Mgr_Heading"><table width="100%"  border="0" align="center" cellpadding="2" cellspacing="5">
      <form name="form1" method="post" action="<?php echo $editFormAction; ?>">
        <tr>
          <td width="20%" align="right" class="td_block">Password:</td>
          <td width="80%">
            <input name="cPsw" type="text" id="cPsw3" value="<?php echo $row_rs['cPsw']; ?>">
          </td>
        </tr>
        <tr>
          <td align="right" class="td_block">Desc:</td>
          <td><input name="cDesc" type="text" id="cDesc3" size="50" value="<?php echo $row_rs['cDesc']; ?>"></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td><input name="Submit" type="submit" class="btn" value="Submit">
              <input name="Submit2" type="reset" class="btn" value="Reset">
              <input name="iID" type="hidden" id="iID2" value="<?php echo $row_rs['iID']; ?>"></td>
        </tr>
