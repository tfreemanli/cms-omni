...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form3")) {
  $updateSQL = sprintf("UPDATE tbopr SET cStatus='deleted' WHERE iID=%s",
...
mysql_select_db($database_localhost, $localhost);
$query_rs = sprintf("SELECT * FROM tbopr WHERE iID = %s", $colname_rs);
...
<table width="538"  border="0" cellpadding="5" cellspacing="2" bgcolor="#CADB2A">
  <form name="form3" enctype="multipart/form-data" method="POST" action="<?php echo $editFormAction; ?>">
    <tr>
      <td width="55%" height="31">■ Delete the operator </td>
...
<table width="538" border="0" cellspacing="5" cellpadding="2"><form name="form1" method="POST" action="<?php echo $editFormAction; ?>">
  <tr bgcolor="#CADB2A">
    <td colspan="2" class="font_white_9bold"><img src="images/1x1.gif" width="1" height="1" hspace="2" vspace="10" align="absmiddle">Modify operator's information </td>
    </tr>
  <tr>
    <td width="123" align="right" bgcolor="#8F1128" class="td_block">Name</td>
    <td width="404"><input name="cName" type="text" class="ipt_normal" id="cName" value="<?php echo $row_rs['cName']; ?>"></td>
  </tr>
  <tr>
    <td align="right" bgcolor="#8F1128" class="td_block">Email</td>
    <td><input name="cEmail" type="text" class="ipt_normal" id="cEmail" value="<?php echo $row_rs['cEmail']; ?>"></td>
  </tr>
  <tr>
    <td align="right" bgcolor="#8F1128" class="td_block">Contact Num </td>
...
<table width="538" border="0" cellspacing="5" cellpadding="2">
  <form name="form2" method="POST" action="<?php echo $editFormAction; ?>">
    <tr bgcolor="#CADB2A">
      <td colspan="2" class="font_white_9bold"><img src="images/1x1.gif" width="1" height="1" hspace="2" vspace="10" align="absmiddle">Modify operator's password </td>
    </tr>
    <tr>
