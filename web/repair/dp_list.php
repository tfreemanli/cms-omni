...
$query_rs = "SELECT * FROM tbdiscpsw ORDER BY iID DESC";
...
<table width="100%"  border="0" align="center" cellpadding="5" cellspacing="10">
  <tr>
    <td width="82%" class="Mgr_Heading">Discount Password </td>
    <td width="18%" align="center" class="td_block"><a href="dp_add.php">Add &gt;&gt; </a> </td>
  </tr>
</table>
  ...
  <tr>
    <td><table width="100%"  border="0" align="center" cellpadding="5" cellspacing="0">
      <tr class="font_white_9bold" align="center">
        <td width="143" background="../manage/images/m_tb_head.gif" class="right_solid_1">Password</td>
        <td width="460" background="../manage/images/m_tb_head.gif" class="right_solid_1">Desc</td>
        <td width="106" background="../manage/images/m_tb_head.gif" class="right_solid_1">Opr</td>
      </tr>
      <?php
   $col = "#FFFFFF";
    do { ?>
      <tr bgcolor="<?php echo $col;?>" class="font_red_12">
        <td bgcolor="<?php echo $col;?>" class="right_solid_2"><?php echo $row_rs['cPsw']; ?></td>
        <td class="right_solid_2"><?php echo $row_rs['cDesc']; ?></td>
        <td bgcolor="<?php echo $col;?>"><a href="dp_edit.php?iID=<?php echo $row_rs['iID']; ?>">Modify</a> <a href="./dp_del.php?iID=<?php echo $row_rs['iID']; ?>" onClick="if(!confirm('Are you sure?')){return false;}">Del</a> </td>
      </tr>
      <?php
  		if($col == "#FFFFFF"){
			$col = "#E3E3E3";
      ...
      <tr>
        <td colspan="6" bgcolor="<?php echo $col?>">
