...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tbtypeinperson SET cName=%s WHERE iID=%s",
...
mysql_select_db($database_localhost, $localhost);
$query_rs = sprintf("SELECT * FROM tbtypeinperson WHERE iID = %s", $colname_rs);
...
<table width="100%"  border="0" align="center" cellpadding="5" cellspacing="10">
	...
	<table width="330" border="0" cellspacing="10" cellpadding="5">
	  <form action="<?php echo $editFormAction; ?>" name="form1" method="POST">
      <tr>
        <td width="72" align="right"><strong>Name:</strong></td>
        <td width="223">
          <input name="cName" type="text" class="ipt_normal" id="cName" value="<?php echo $row_rs['cName']; ?>">
        </td>
      </tr>
      <tr>
        <td>&nbsp;</td>
