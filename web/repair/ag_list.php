...
if(isset($_GET['cField'])){
	...
	$where_clu .= " and cIsVIP='1' and  cStatus = 'normal'";
...
function do_sch(){
	...
	MM_goToURL('window','ag_list.php?cField='+ field.options[field.selectedIndex].value +'&cOp='+ op.options[op.selectedIndex].value +'&cVal='+ val.value);
	return;
}
//-->
...
<table width="100%"  border="0" align="center" cellpadding="5" cellspacing="10">
  <tr>
    <td width="82%" class="Mgr_Heading">Agents</td>
    <td width="18%" align="center" class="td_block"><a href="ag_add.php">ADD &gt;&gt;</a> </td>
  </tr>
</table>
...
&nbsp;&nbsp;&nbsp;
        <select name="field" id="field">
          ...
          <option value="cVIPNum">Agent Num</option>
  ...
  <tr>
    <td><table width="100%"  border="0" align="center" cellpadding="5" cellspacing="0">
      <tr class="font_white_9bold" align="center">
        <td width="112" background="../manage/images/m_tb_head.gif" class="right_solid_1">Name</td>
        <td width="20" background="../manage/images/m_tb_head.gif" class="right_solid_1">Num</td>
        <td width="105" background="../manage/images/m_tb_head.gif" class="right_solid_1">Home Ph </td>
        <td width="102" background="../manage/images/m_tb_head.gif" class="right_solid_1">Work/Other Ph</td>
        <td width="165" background="../manage/images/m_tb_head.gif" class="right_solid_1">Address</td>
        <td width="78" background="../manage/images/m_tb_head.gif" class="right_solid_1">Email</td>
        <td width="52" background="../manage/images/m_tb_head.gif" class="right_solid_1">Opr</td>
      </tr>
      <?php
   $col = "#FFFFFF";
    do { ?>
      <tr bgcolor="<?php echo $col;?>" class="font_red_12">
        ...
        <td class="right_solid_2"><?php echo $row_rs['cVIPNum']; ?>&nbsp;</td>
        ...
        <td class="right_solid_1"><a href="ag_edit.php?iID=<?php echo $row_rs['iID']; ?>">Modify</a></td>
      </tr>
      <?php
  		if($col == "#FFFFFF"){
			$col = "#E3E3E3";
