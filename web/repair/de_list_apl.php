...
$query_rs = "SELECT * FROM tbdeal WHERE cStatus = 'apply' ORDER BY iID DESC";
...
function de_del(id){
	if(cfm()){
		MM_goToURL('window','de_unauth.php?ID=' + id);
		//alert('yes ticked.');
		return true;
	}
	return false;
...
<table width="100%"  border="0" align="center" cellpadding="5" cellspacing="10">
  <tr>
    <td width="82%" class="Mgr_Heading">Dealer (Applying)</td>
    <td width="18%" align="center" class="td_block"><a href="de_list.php">&lt;&lt; Back to list</a></td>
  </tr>
</table>
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="10">
  <tr>
    <td class="Mgr_Heading"><table width="100%"  border="0" align="center" cellpadding="5" cellspacing="0">
      <tr class="font_white_9bold" align="center">
        <td width="93" background="../manage/images/m_tb_head.gif" class="right_solid_1">Login</td>
        <td width="118" background="../manage/images/m_tb_head.gif" class="right_solid_1">Company Name</td>
        <td width="100" background="../manage/images/m_tb_head.gif" class="right_solid_1">Email</td>
        <td width="120" background="../manage/images/m_tb_head.gif" class="right_solid_1">Contact No.</td>
        <td width="114" background="../manage/images/m_tb_head.gif" class="right_solid_1">Contact Person</td>
        <td width="174" background="../manage/images/m_tb_head.gif" class="right_solid_1">Opr</td>
      </tr>
      <?php
   $col = "#FFFFFF";
    do { ?>
      <tr bgcolor="<?php echo $col;?>" class="font_red_12">
        <td bgcolor="<?php echo $col;?>" class="right_solid_2"><?php echo $row_rs['cLogin']; ?></td>
        <td class="right_solid_2"><?php echo $row_rs['cName']; ?></td>
        <td class="right_solid_2"><?php echo $row_rs['cEmail']; ?></td>
        <td class="right_solid_2"><?php echo $row_rs['cContact']; ?></td>
        <td class="right_solid_2"><?php echo $row_rs['cPerson']; ?></td>
        <td>&nbsp;
            <?php
if($_SESSION['RP_Username']=="admin"){
?>
            <a href="de_auth.php?iID=<?php echo $row_rs['iID']; ?>">Auth</a> <a href="#" onClick="javascript:de_del(<?php echo $row_rs['iID']; ?>);">Unauth</a>
            <?php
	}
	?>
        </td>
