...
$query_rs = "SELECT * FROM tbopr WHERE cStatus = 'normal' and cLogin<>'admin' and role='user' ORDER BY iID DESC";
...
<table width="100%"  border="0" align="center" cellpadding="5" cellspacing="10">
  <tr>
    ...
    <td width="18%" align="center" class="td_block"><a href="op_add.php">ADD &gt;&gt;</a> </td>
  </tr>
</table>
  ...
  <tr>
    <td class="Mgr_Heading"><table width="100%"  border="0" align="center" cellpadding="5" cellspacing="0">
      <tr class="font_white_9bold" align="center">
        <td width="117" background="../manage/images/m_tb_head.gif" class="right_solid_1">Login</td>
        <td width="136" background="../manage/images/m_tb_head.gif" class="right_solid_1">Name</td>
        <td width="150" background="../manage/images/m_tb_head.gif" class="right_solid_1">Email</td>
        <td width="214" background="../manage/images/m_tb_head.gif" class="right_solid_1">Contact No.</td>
        <td width="91" background="../manage/images/m_tb_head.gif" class="right_solid_1">Opr</td>
      </tr>
      <?php
   $col = "#FFFFFF";
    do { ?>
      <tr bgcolor="<?php echo $col;?>">
        ...
        <td><a href="op_edit.php?iID=<?php echo $row_rs['iID']; ?>">Modify</a></td>
      </tr>
      <?php
  		if($col == "#FFFFFF"){
			$col = "#E3E3E3";
      ...
      <tr>
        <td colspan="9" bgcolor="<?php echo $col?>">&nbsp; </td>
      </tr>
    </table></td>
    </tr>
</table>
