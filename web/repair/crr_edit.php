...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tbcourier SET name=%s, url=%s, memo=%s WHERE id=%s",
...
mysql_select_db($database_localhost, $localhost);
$query_rs = sprintf("SELECT * FROM tbcourier WHERE id = %s", $colname_rs);
...
<table width="100%"  border="0" align="center" cellpadding="5" cellspacing="10">
	...
	<table width="482" border="0" align="center" cellpadding="5" cellspacing="5"><form action="<?php echo $editFormAction; ?>" name="form1" method="POST">
      <tr>
        <td width="58">Name</td>
        <td width="389">
          <input name="cName" type="text" class="ipt_normal" id="cName" value="<?php echo $row_rs['name']; ?>">
          *
        </td>
      </tr>
      <tr>
        <td>Website</td>
        <td>http://
          <input name="cURL" type="text" class="ipt_normal" id="cURL" style="width:300px" value="<?php echo $row_rs['url']; ?>">
          <input name="cMemo" type="hidden" id="cMemo" value="<?php echo $row_rs['memo']; ?>">
          <input name="iID" type="hidden" id="iID" value="<?php echo $row_rs['id']; ?>"></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
