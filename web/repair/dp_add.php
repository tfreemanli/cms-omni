...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tbdiscpsw (cPsw, cDesc) VALUES (%s, %s)",
...
<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="10">
  <tr>
    <td class="Mgr_Heading"><table width="100%"  border="0" align="center" cellpadding="5" cellspacing="2">
      <form name="form1" method="post" action="<?php echo $editFormAction; ?>">
        <tr>
          <td width="20%" align="right" class="td_block">Password:</td>
          <td width="80%">
            <input name="cPsw" type="text" id="cPsw">
          </td>
        </tr>
        <tr>
