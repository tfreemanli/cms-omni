...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tbdeal (cLogin, cPasswd, cName, cEmail, cContact, cAdd, cMailAdd, cPerson, cVIP, cDesc) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
function add_usr(){
	MM_validateForm('cLogin','','R','cName','','R','cPasswd','','R','cPasswd2','','R','cEmail','','RisEmail','cContact','','R');
...
<form name="form1" method="POST" action="<?php echo $editFormAction; ?>">
  ...
  <tr>
    <td align="right" class="td_block">Company Name:</td>
    <td><input name="cName" type="text" class="ipt_normal" id="cName"></td>
  </tr>
  <tr>
    <td align="right" class="td_block">Company Address:</td>
  ...
  <tr>
    ...
    <td><input name="cVIP" type="checkbox" id="cVIP" value="checked">    </td>
  </tr>
  <tr>
