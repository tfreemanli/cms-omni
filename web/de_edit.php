...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tbdeal SET cName=%s, cEmail=%s, cContact=%s, cAdd=%s, cMailAdd=%s, cPerson=%s, cDesc=%s WHERE cLogin=%s",
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form_psw")) {
  $updateSQL = sprintf("UPDATE tbdeal SET cPasswd=%s WHERE cLogin=%s",
...
$colname_rs = "1";
if (isset($_SESSION['DE_Username'])) {
  $colname_rs = (get_magic_quotes_gpc()) ? $_SESSION['DE_Username'] : addslashes($_SESSION['DE_Username']);
}
mysql_select_db($database_localhost, $localhost);
$query_rs = sprintf("SELECT * FROM tbdeal WHERE cLogin = '%s'", $colname_rs);
      ...
      <!-- InstanceBeginEditable name="main" --><br>
		  ...
		  <tr>
            ...
            <tr>
              ...
              <td>
                ...
                <input name="cLogin" type="hidden" id="cLogin" value="<?php echo $row_rs['cLogin']; ?>"></td>
            </tr>
        ...
        <table width="538" border="0" cellspacing="1" cellpadding="2">
          <form name="form_psw" method="POST" action="<?php echo $editFormAction; ?>" id="form_psw">
            <tr>
              <td colspan="2" class="STYLE1"><img src="images/1x1.gif" width="1" height="1" hspace="2" vspace="10" align="absmiddle">Modify Dealer's password </td>
            </tr>
            <tr>
