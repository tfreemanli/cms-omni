...
if(isset($_GET['iID'])){
	...
	$query_RS = sprintf("SELECT * FROM tbanm WHERE iAorM = 3 and iID=%s ORDER BY cPC, dtDate DESC", $_GET['iID']);
    ...
    <td width="593" rowspan="2" bgcolor="#FFFFFF">
      ...
      <table width="95%"  border="0" align="center" cellpadding="5" cellspacing="5">
        <tr>
          ...
          <td colspan="2" bgcolor="#EFEFEF"><?php echo $row_RS['cPC']; ?>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td width="23%" valign="top"><img src="./productimg/<?php echo $row_RS['cImg']; ?>" width="140" height="186" hspace="20" vspace="5"></td>
