...
if(isset($_POST['MM_Search']) && $_POST['MM_Search']=="form1"){
	$cBrand = $_POST['cBrand'];
	$cModel = $_POST['cModel'];
	$cFeature = str_replace(" ","%",ltrim(rtrim($_POST['cFeature'])));
	$cIs3G = $_POST['cIs3G'];
}

mysql_select_db($database_localhost, $localhost);
$query_RS = "SELECT iID, cBrand,cModel,cFeature,cImg FROM tbphone where iID is not null";
$query_RS .= " and cBrand like '%". $cBrand ."%'";
$query_RS .= " and cModel like '%". $cModel ."%'";
$query_RS .= " and cFeature like '%". $cFeature ."%'";
$query_RS .= " and cIs3G like '%". $cIs3G ."%'";
$query_RS .= " limit 0,20";// WHERE MATCH (cBrand,cIs3G,cModel,cFeature) AGAINST ('".$str."' IN boolean MODE) limit 0,20";
//echo $query_RS;
    ...
    <td width="593" rowspan="2" bgcolor="#FFFFFF">
      ...
      <table width="530" border="0" align="center" cellpadding="2" cellspacing="0">
        ...
        <tr>
          <td colspan="2">&nbsp;
		  <?php 
		  if($totalRows_RS>19) echo "We've got SO MANY matched mobiles, you may try to put more keywords in your searh.";
		  ?>
		  </td>
        </tr>
			<?php
		...
		}else{ //if no resultset
		?>
			<tr>
			  <td align="center" valign="top">&nbsp;</td>
			  <td valign="top">Sorry, No match mobile is found. <a href="sch_adv.php">Try Again?</a> </td>
			</tr>
		<?php
		}
			?>
