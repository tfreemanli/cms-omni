...
$query_RS = sprintf("SELECT * FROM tbphone WHERE iID = %s", $colname_RS);
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr valign="top">
    <td width="207" bgcolor="#FFFFFF"><table width="207" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td valign="top"><!-- InstanceBeginEditable name="Nav" --><?php include('./inc_ph_menu.php');?>
<br>
      ...
      <table width="593" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td valign="top"><table width="100%" border="0" cellspacing="10" cellpadding="0">
            <tr>
              <td width="43%" rowspan="2" align="center" valign="top"><a href="./productimg/<?php echo $row_RS['cImg']; ?>" target="_blank"><img src="./productimg/<?php echo $row_RS['cImg']; ?>" width="140" height="186" hspace="0" vspace="0" border="0"></a></td>
              <td width="57%" valign="top"><span class="head_red_bold"><?php echo $row_RS['cBrand']; ?> <?php echo $row_RS['cModel']; ?></span><hr size="2" noshade></td>
            </tr>
            <tr>
              <td valign="top"><p><strong>Feature:</strong><br>
                  </p>
                <?php echo str_replace("\n","<br>",$row_RS['cFeature']); ?></td>
            </tr>
            <tr>
              <td colspan="2" valign="top"><STRONG>Disclaimer: The phone that showing on this page is NOT FOR SALE, this is only for your information or review and we cannot guarantee that the information   on this page is 100% correct.</STRONG></td>
              </tr>
          </table>          
          <p>&nbsp;</p></td>
        </tr>
