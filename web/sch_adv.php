...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr valign="top">
    ...
    <td width="593" rowspan="2" bgcolor="#FFFFFF">
      ...
      <table width="530" border="0" align="center" cellpadding="2" cellspacing="2">
        <tr>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td class="head_red_bold">Phone Search</td>
        </tr>
        <tr>
          <td>Please input the required features and click the Search button.</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td><table width="500" border="0" cellspacing="1" cellpadding="3"><form name="form1" method="post" action="sch_adv_res.php">
            <tr>
              <td width="83" bgcolor="#F4F4F4">Brand</td>
              <td width="402" bgcolor="#F4F4F4"><select name="cBrand" class="ipt_normal" id="cBrand">
            ...
            <tr>
              <td bgcolor="#F4F4F4">Model</td>
              <td bgcolor="#F4F4F4"><input name="cModel" type="text" class="ipt_normal" id="cModel"></td>
            </tr>
            <tr>
              <td bgcolor="#F4F4F4">Features</td>
              <td bgcolor="#F4F4F4"><input name="cFeature" type="text" class="text_normal" id="cFeature" value=""> 
                <span class="STYLE2">eg. 'MP3', 'pdf' etc. </span></td>
            </tr>
            <tr>
              <td bgcolor="#F4F4F4">3G</td>
              <td bgcolor="#F4F4F4"><input name="cIs3G" type="checkbox" id="cIs3G" value="checked">
                </td>
            </tr>
            <tr>
              <td bgcolor="#F4F4F4">&nbsp;</td>
              <td bgcolor="#F4F4F4"><input type="submit" name="Submit" value="Search">
                <input name="MM_Search" type="hidden" id="MM_Search" value="form1"></td>
            </tr></form>
          </table></td>
        </tr>
        <tr>
